    ...
    <Card>
      ...
      <div class="search_box">
        <div class="search_input">
          <span>关键字</span>
          <Input v-model="serValue" placeholder="企业名称/姓名" />
        </div>
        ...
        <Button class="add_btn" type="primary" @click="addBtn">导入资源池</Button>
      ...
      <!-- tabs表格 -->
      <Tabs value="公海" @on-click="tabsChange">
        <TabPane label="公海" name="公海">
          <Table :loading="loading"  ref="selection" :columns="highSeas" :data="highSeasData"></Table>
        </TabPane>
        <TabPane label="已分配" name="已分配">
          <Table :loading="loading"  ref="selection" :columns="highDistribution" :data="highDistributionData"></Table>
        </TabPane>
      </Tabs>
      <!-- 分页 -->
