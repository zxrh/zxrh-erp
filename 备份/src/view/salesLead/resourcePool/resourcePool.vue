  ...
  <div id="resource_pool">
    ...
    <div class="search_box">
      <div class="search_input">
        <span>关键字</span>
        <Input v-model="serValue" style="width:150px;" placeholder="企业名称/电话号码/姓名" />
      </div>
      <div class="select_box">
        <span class="enterprise">企业状态</span>
        <Select v-model="enterpriseState" style="width:180px" @on-change="enterpriseChange">
          <Option
      ...
      <div class="select_box">
        ...
        <Select v-model="customerLevel" style="width:180px" @on-change="customerChange">
          <Option
      ...
      <div class="select_box">
        ...
        <Select v-model="department" style="width:150px" @on-change="departmentChange">
          <Option
